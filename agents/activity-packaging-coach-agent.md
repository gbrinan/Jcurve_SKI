...
# Activity Packaging Coach Agent
...
- Keep the approved Wireframe Coach surface separate: `tobe.html` confirms structure; `agent-mockup.html` demonstrates Activity execution after approval.
